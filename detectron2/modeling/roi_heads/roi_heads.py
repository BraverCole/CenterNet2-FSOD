...
class StandardROIHeads(ROIHeads):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # self.box_pooler1 = box_pooler1
        self.box_pooler2 = box_pooler2
        ...
        # self.avgpool_fc = nn.AvgPool2d(8)
        #attention_rpn
        
            self.avgpool_fc = nn.AvgPool2d(7)
            self.conv_cor = nn.Conv2d(256, 256, 1, padding=0, bias=False)
            self.avgpool = nn.AvgPool2d(kernel_size=3,stride=1)
            self.conv_1 = nn.Conv2d(256*2, int(256/4), 1, padding=0, bias=False)
            self.conv_2 = nn.Conv2d(int(256/4), int(256/4), 3, padding=0, bias=False)
            self.conv_3 = nn.Conv2d(int(256/4), 256, 1, padding=0, bias=False)
            self.conv_cor = nn.Conv2d(256, 256, 1, padding=0, bias=False)
            self.fc_1 = nn.Linear(256 * 2, 256)
