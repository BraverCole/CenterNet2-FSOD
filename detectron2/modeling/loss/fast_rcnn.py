...
class RepLossFastRCNNOutputs(FastRCNNOutputs):
    ...
    def rep_gt_loss(self):
        ...
        # calculate loss
        iogs = iog(repulsion_targets, box_preds)
        losses = smooth_ln(iogs, sigma=self.rep_gt_sigma)
    ...
    # def smooth_l1_loss(self, sigma=1.0, dim=[1]):
    #     sigma_2 = sigma ** 2
    ...
    def repulsion_loss(self):
        ...
        # repulsion_loss = self.rep_gt_factor*loss_rep_gt + self.rep_box_factor*loss_rep_box
